...
func TestGetConfigPath(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join("/tmp/home", ".operator", "config.json")
...
func TestGetConfigPath_Windows(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join(testUserProfilePath, ".operator", "config.json")
...
func TestGetConfigPath_WithEnv(t *testing.T) {
	t.Setenv("OPERATOR_CONFIG", "/tmp/custom/config.json")
