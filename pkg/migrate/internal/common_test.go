...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.operator")
	assert.Equal(t, "/home/user/.operator/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.operator/workspace/file.txt", "/home/user/.operator")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".operator"), result)
}
